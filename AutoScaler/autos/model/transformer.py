...
class TransformerDecoder(nn.Module):
    ...
    def forward(self, tgt: Tensor, memory: Tensor, tgt_mask: Optional[Tensor] = None,
        ...
        for mod in self.layers:
            output, amap = mod(output, memory, tgt_mask=tgt_mask,
...
class TransformerDecoderLayer(nn.Module):
    ...
    def __init__(self, d_model, nhead, dim_feedforward=2048, dropout=0.1, activation="relu"):
        ...
        self.multihead_attn.in_cross = False
        self.self_attn.in_cross = False
    ...
    def forward(self, tgt: Tensor, memory: Tensor, tgt_mask: Optional[Tensor] = None, memory_mask: Optional[Tensor] = None,
        ...
        tgt = self.norm1(tgt)
        self.multihead_attn.in_cross=True
        tgt2, amap = self.multihead_attn(tgt, memory, memory, attn_mask=memory_mask, key_padding_mask=memory_key_padding_mask)
        self.multihead_attn.in_cross=False
